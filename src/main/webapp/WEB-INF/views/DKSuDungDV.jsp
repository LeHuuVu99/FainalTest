...
<body>
	<form:form modelAttribute="QuanNet" action="addQuanNet" method="post"
		id="Formsudungdv">
		<div
			...
			<div style="height: 100%;" class="row">
				...
				<div
					...
					<div
						...
						class="row">
						<p>
							<a href="indexPage" style="color: rgb(236, 234, 234);">Quản lý người
								dùng</a>
						</p>
					</div>
					<div style="color: rgb(236, 234, 234);" class="row">
						<h5>Đăng Ký Sử Dụng Dịch Vụ</h5>
					</div>
					...
					<div class="form-outline">
						...
						<form:select path="maDv" cssClass="form-control">
							<form:options items="${dichVuList}" />
						</form:select>
					</div>
					<div class="form-outline mb-4">
						<label class="form-label" for="form6Example6">Ngày Sử Dụng</label>
						<form:input path="ngaySuDung" cssClass="form-control "
							placeholder="Ngày Sử Dụng" name="ngaySuDung1" type="date" />
					</div>
					<div class="form-outline">
						<label class="form-label" for="form6Example2">Giờ Sử Dụng</label>
						<form:input path="gioSuDung" type="time" cssClass="form-control"
							placeholder="Giờ Sử Dụng" name="gioSuDung1" />
					</div>
					<div class="form-outline">
						<label class="form-label" for="form6Example2">Số Lượng</label>
						<form:input path="soLuong" cssClass="form-control "
							placeholder="Số Lượng" name="soLuong1" />
					</div>
					<button
